        ...
        return (
            <div className="settings">
                ...
                <div className="settings-flex-item">
                    ...
                    <label for="search-setting" className="settings-label">
                ...
                <div className="settings-flex-item">
                    ...
                    <label for="user-feedback-surveys-setting" className="settings-label">
                    ...
                    <label for="recipes-just-for-you-setting" className="settings-label">
                    ...
                    <label for="educational-content-setting" className="settings-label">
                    ...
                    <label for="deals-we-love-setting" className="settings-label">
                    ...
                    <label for="curated-seasonal-recipes-setting" className="settings-label">
                    ...
                    <label for="cool-my-recipe-features-setting" className="settings-label">
